			...
			<div className="space-y-6">
				<div className="flex items-center justify-between">
					...
					<div className="space-x-2">
						<Button variant="outline" onClick={markAllRead} disabled={loading || items.length === 0}>Mark all read</Button>
						<Button variant="destructive" onClick={clearAll} disabled={loading || items.length === 0}>Clear all</Button>
					</div>
				</div>
									...
									<div className="flex-1 min-w-0">
										<div className="flex items-center justify-between mb-2">
											...
											<div className="flex items-center space-x-2">
												...
												{n.created_at && <span className="text-sm text-gray-500">{new Date(n.created_at).toLocaleString()}</span>}
											</div>
										</div>
